...
<details>
<summary><b>[161] Cabin-Italic[wdth,wght].ttf</b></summary>
<details>
...
* 🔥 **FAIL** The file 'Cabin-Italic[wdth,wght].ttf' must be renamed to 'Cabin-Italic[WIDT,wght].ttf' according to the Google Fonts naming policy for variable fonts. [code: bad-varfont-filename]
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 3.001'] [code: version-not-detected]
...
* ℹ **INFO** The family name "Cabin" seems to be already in use.
...
* ℹ **INFO** Version string is: "Version 3.001"
...
* ℹ **INFO** This font contains the following optional tables [DSIG, prep, GPOS, gasp, GSUB, loca]
...
* 🍞 **PASS** Name Table entry: Copyright field 'Copyright 2018 The Cabin Project Authors (https://github.com/impallari/Cabin.git)' matches canonical pattern.
